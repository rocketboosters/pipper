...
def test_comparison():
    ...
    rv1 = versioning.to_remote_version("tests", "0.0.1-alpha.1", "FAKE")
    rv2 = versioning.to_remote_version("tests", "0.0.1", "FAKE")
    rv3 = versioning.to_remote_version("tests", "0.1.0", "FAKE")
